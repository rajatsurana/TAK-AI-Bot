...
bool isCapStone(int type){
	return (type==31 || type ==32)?1:0;
}
bool isFlatStone(int type){
	return (type==11 || type ==12)?1:0;
}
bool isStandingStone(int type){
	return (type==21 || type ==22)?1:0;
}
